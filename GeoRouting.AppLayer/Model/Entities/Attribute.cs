...
namespace GeoRouting.AppLayer.Model.Entities
{
    ...
    public class Attribute
    {
        ...
        [Association(ThisKey = "CategoryId", OtherKey = "Id", CanBeNull = false, Relationship = Relationship.ManyToOne, KeyName = "attributes_category_fkey", BackReferenceName = "attributescategoryfkeys")]
